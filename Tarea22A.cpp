	...
	do{
		...
		switch(op){
			case '1': cout<<"Ingresa el valor del nodo: "; cin>>valor;
					A1.Insertar(A1.raiz, valor);
				break;
			case '2': cout<<"Ingresa el valor del nodo a eliminar: "; cin>>valor;
					A1.Eliminar(A1.raiz, A1.raiz, valor);
				break;
			case '3': cout<<"Ingresa el valor del nodo a buscar: "; cin>>valor;
					A1.Buscar(A1.raiz, valor);
				break;
			case '4': A1.Pre(A1.raiz);
				break;
			case '5': A1.In(A1.raiz);
				break;
			case '6': A1.Post(A1.raiz);
				break;
			case '7':cout<<"Saliste de la aplicacion"<<endl;
				break;
